    ...
    <div class="card-body">
        <form method="POST" action="{{ route("products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_price') ? 'is-invalid' : '' }}" type="number" name="product_price" id="price" value="{{ old('product_price', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('product_image') ? 'is-invalid' : '' }}" id="photo-dropzone">
                </div>
