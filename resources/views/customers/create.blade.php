            ...
            <div class="card-body">
                <form method="POST" action="{{ route("customers.store") }}" enctype="multipart/form-data" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control {{ $errors->has('tel_num') ? 'is-invalid' : '' }}" type="text" name="tel_num" id="tel_num" value="{{ old('tel_num', '') }}" >
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label " for="roles">{{ trans('global.status') }}</label>
                        <div class="col-md-10">
                            <label >TRUE</label>
                        </div>
